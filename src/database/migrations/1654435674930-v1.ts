...
export class v11654435674930 implements MigrationInterface {
  name = 'v11654435674930';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "product_category_translate" ("id" SERIAL NOT NULL, "title" character varying NOT NULL, "slug" character varying, "description" character varying NOT NULL, "langId" integer, "category_id" integer, CONSTRAINT "UQ_e17dec812a86d58a14a7af79c45" UNIQUE ("slug"), CONSTRAINT "PK_e597f8a95b1fea4ec120a4f885d" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "product_category" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, CONSTRAINT "PK_0dce9bc93c2d2c399982d04bef1" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "product_category_translate" ADD CONSTRAINT "FK_149ae02ac0657e029baedb85259" FOREIGN KEY ("langId") REFERENCES "language"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "product_category_translate" ADD CONSTRAINT "FK_a631e5034a814ed05e7fed04031" FOREIGN KEY ("category_id") REFERENCES "product_category"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "product_category_translate" DROP CONSTRAINT "FK_a631e5034a814ed05e7fed04031"`,
    );
    await queryRunner.query(
      `ALTER TABLE "product_category_translate" DROP CONSTRAINT "FK_149ae02ac0657e029baedb85259"`,
    );
    await queryRunner.query(
